/**
 * Created by mzavgorodny on 11.06.2015.
 *//*
...
/*    public void testConnectFirst() throws MqttException, IOException, InterruptedException {
    ...
    public void testInvalidPassword() throws MqttException, InterruptedException {
        conOpt.setUserName("link");
        conOpt.setPassword("link".toCharArray());
